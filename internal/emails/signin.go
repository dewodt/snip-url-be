			...
			<td>
				...
				<tbody>
					...
					<td>
						...
						"
						>
						Click this button below if you want to verify sign in / sign
						up request to
						<span class="il">Snip</span>
						<span class="il">URL</span>! After you clicked this, you
						will be signed in and redirected to the app.
						</p>
						<a
						href="%s/api/auth/email/callback?token=%s&email=%s"
						style="
							border-radius: 0.375rem;
